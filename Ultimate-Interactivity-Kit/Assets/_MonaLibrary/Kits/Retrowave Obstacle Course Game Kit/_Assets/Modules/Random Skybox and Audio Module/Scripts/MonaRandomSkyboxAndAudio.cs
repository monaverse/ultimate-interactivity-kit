...
public class MonaRandomSkyboxAndAudio : MonoBehaviour
{
    [HideInInspector]
    public string imagePath = "Assets/_MonaLibrary/_Assets/Mona-Logo.png";
    public string ModuleName = "";
    public string ModuleCreator = "Random Skybox and Audio Module";
    ...
    public string Link2 = "https://www.youtube.com/watch?v=nN6NStQGuPU";
