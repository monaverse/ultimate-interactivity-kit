...
public class MonaMovingPlatform : MonoBehaviour
{
    [HideInInspector]
    public string imagePath = "Assets/_MonaLibrary/_Assets/Mona-Logo.png";
    public string ModuleName = "";
    public string ModuleCreator = "Moving Platform Module";
    ...
    public string Link2 = "https://www.youtube.com/watch?v=AJz8UMzsLdM";
