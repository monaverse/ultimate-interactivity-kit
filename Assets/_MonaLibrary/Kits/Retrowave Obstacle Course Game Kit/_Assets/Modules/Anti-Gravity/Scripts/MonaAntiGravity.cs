...
public class MonaAntiGravity : MonoBehaviour
{
    [HideInInspector]
    public string imagePath = "Assets/_MonaLibrary/_Assets/Mona-Logo.png";
    public string ModuleName = "";
    public string ModuleCreator = "Anti-Gravity Module";
    ...
    public string Link2 = "https://www.youtube.com/watch?v=xbS3HAMIK68";
