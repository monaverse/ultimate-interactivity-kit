...
public class MonaSuperJumpPowerup : MonoBehaviour
{
    [HideInInspector]
    public string imagePath = "Assets/_MonaLibrary/_Assets/Mona-Logo.png";
    public string ModuleName = "";
    public string ModuleCreator = "Super Jump Powerup Module";
    ...
    public string Link2 = "https://www.youtube.com/watch?v=o9IjUwocJWE";
